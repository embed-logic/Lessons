...
module tb_alu;
    ...
    task automatic check_alu;
        ...
        input [1:0] op_val;
        begin
            $display("Check_ALU expected=%0d, op=%0d", expected, op_val);
            a = a_val;  b = b_val;  op = op_val;
            @(posedge clk); #1;     // cycle 1: inputs -> a_reg/b_reg/op_reg
            @(posedge clk); #2;     // cycle 2: result_reg <= alu_result
    ...
    initial begin
        ...
        check_alu(4'd6, 4'd5, 4'd11, 2'b11);
        check_alu(4'd3, 4'd7, 4'd10, 2'b00);
